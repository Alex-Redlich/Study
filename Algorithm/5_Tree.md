...
![이진탐색 트리](../image/20230222/20230222_18.PNG)
...
![탐색연산](../image/20230222/20230222_19.PNG)

#### 삽입연산
1. 먼저 탐색 연산을 수행
   - 삽입할 원소와 같은 원소가 트리에 있으면 삽입할 수 없으므로, 같은 원소가 트리에 있는지 탐색하여 확인한다.
   - 탐색에서 탐색 실패가 결ㄱ정되는 위치가 삽입 위치가 된다.
2. 탐색 실패한 위치에 원소를 삽입한다.
    - 다음 예는 5를 삽입하는 예

![삽입연산](../image/20230222/20230223_1.PNG)

#### 삭제연산
1. 먼저 탐색 연산을 수행
    - 자식이 없는 경우 : 끊고 날리기
    - 자식이 있는경우 : 자식을 위에 부모랑 이어줌
    - 삭제 할 것이 루트인 경우 : 왼쪽 서브트리의 가장 오른쪽 노드랑 자리를 바꿈
...
![힙](../image/20230222/20230223_2.PNG)

#### 힙 연산 - 삽입

![힙2](../image/20230222/20230223_3.PNG)
